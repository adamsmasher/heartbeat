package  
{
	...
	public class Script 
	{
		...
		private static var script:Array = [
			...
			new WaitEvent(300),
			// sentence drop
			new TextDrop(50, 75, "I", Game.Color_Blue),
			new WaitEvent(15),
			new TextDrop(80, 75, "THINK", Game.Color_Red),
			new WaitEvent(15),
			new TextDrop(260, 75, "WE", Game.Color_Blue),
			new WaitEvent(15),
			new TextDrop(410, 75, "SHOULD", Game.Color_Red),
			new WaitEvent(15),
			new TextDrop(610, 75, "TALK", Game.Color_Blue),
			new WaitEvent(150),
			// random argument
